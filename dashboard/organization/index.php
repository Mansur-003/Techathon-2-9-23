...
<body>
    ...
    <div class="main">
        ...
        <div class="sort">
            <a href="add_event.php">Add New Post</a>
            <!-- <p>Sort</p>
            <div class="sort-list">
                <select>
        ...
        <div class="wrapper">
            ...
            <?php
            $sql = "SELECT * FROM `event` WHERE `organization_id`='$id'";
            $result = mysqli_query($conn, $sql);
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    while ($organ_row = mysqli_fetch_assoc($organ_result)) {
                        ...
                        <div class="card-left blue-bg">
                            <img src="profile_pictures/' ?><?= $organ_row['img'] ?><?php echo '">
                        </div>
                        ...
                        <div class="card-right">
                            ...
                            <a href="event.php?catid=' . $event_id . '" style="background: #4c50d3;
                            color: white;
                            border-radius: 10px;
                            padding: 7px;
                            margin-top: 5px;
...
<scrip type="module" src="https://unpkg.com/ionicons@7.1.0/dist/ionicons/ionicons.esm.js"></scrip>
